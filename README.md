...
|:---:|---:|---:|---|
| ✅ Fully supported | **2,482** | **55.4%** | Static definition and all extracted features are supported. |
| 🟡 Usable partial | **1,676** | **37.4%** | Some features are missing, but at least one reliable data path remains. |
