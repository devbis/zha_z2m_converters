...
|:---:|---:|---:|---|
| ✅ Fully supported | **2,629** | **58.7%** | Static definition and all extracted features are supported. |
| 🟡 Usable partial | **1,572** | **35.1%** | Some features are missing, but at least one reliable data path remains. |
