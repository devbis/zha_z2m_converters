...
|:---:|---:|---:|---|
| ✅ Fully supported | **2,627** | **58.7%** | Static definition and all extracted features are supported. |
| 🟡 Usable partial | **1,574** | **35.1%** | Some features are missing, but at least one reliable data path remains. |
