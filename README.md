...
|:---:|---:|---:|---|
| ✅ Fully supported | **2,645** | **59.1%** | Static definition and all extracted features are supported. |
| 🟡 Usable partial | **1,556** | **34.7%** | Some features are missing, but at least one reliable data path remains. |
