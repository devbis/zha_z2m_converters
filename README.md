...
|:---:|---:|---:|---|
| ✅ Fully supported | **2,573** | **57.5%** | Static definition and all extracted features are supported. |
| 🟡 Usable partial | **1,627** | **36.3%** | Some features are missing, but at least one reliable data path remains. |
