...
|:---:|---:|---:|---|
| ✅ Fully supported | **2,584** | **57.7%** | Static definition and all extracted features are supported. |
| 🟡 Usable partial | **1,617** | **36.1%** | Some features are missing, but at least one reliable data path remains. |
