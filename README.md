...
|:---:|---:|---:|---|
| ✅ Fully supported | **2,456** | **54.8%** | Static definition and all extracted features are supported. |
| 🟡 Usable partial | **1,702** | **38.0%** | Some features are missing, but at least one reliable data path remains. |
